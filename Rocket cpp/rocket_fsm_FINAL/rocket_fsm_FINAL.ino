...
const float height_rail = 8.0; // Height of the launch rail in meters + 0.5m
...
void handleRoot() {
    ...
    html += "<a href='/abort'><button>AbortArm</button></a>&nbsp;";
    html += "<a href='/reset'><button>ResetRecover</button></a>&nbsp;";
